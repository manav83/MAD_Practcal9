package com.example.madpractical9_21012022050
...
import com.example.madpractical9_21012022050.databinding.SmsItemViewBinding
...
class SMSViewAdapter(context: Context, private val array:ArrayList<SMSView>):
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        binding.textViewPhoneNo.text = currentSms!!.sPhoneNo
        binding.textViewMessage.text = currentSms.sMessage
        return binding.root
